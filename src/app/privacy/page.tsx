          ...
          <FadeIn>
            ...
            <div className="prose-warm mt-8">
              ...
              <ul>
                ...
                <li>Information about your coating operation needed to quote insurance (crew size, spray equipment value, coating types, job types, annual revenue, payroll, loss history)</li>
